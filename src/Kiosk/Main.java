...
public class Main {
    public static void main(String[] args){
        ...
        menu.addMenu("Order","장바구니를 확인 후 주문합니다.");
        menu.addMenu("Cancel","진행중인 주문을 취소합니다.");
        ...
        menu.addProduct("Forzen Custard","Hamburger","비프패티를 기반으로 야채가 들어간 기본버거",5.4);

        menu.onboard();
        //menu.products_onboard(1);
